...
public class NativeAutoSuggestBox_SuggestCompleteAdapter_SuggestFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("dotMorten.Xamarin.Forms.NativeAutoSuggestBox+SuggestCompleteAdapter+SuggestFilter, dotMorten.Xamarin.Forms.AutoSuggestBox", NativeAutoSuggestBox_SuggestCompleteAdapter_SuggestFilter.class, __md_methods);
	}


	public NativeAutoSuggestBox_SuggestCompleteAdapter_SuggestFilter ()
	{
		super ();
		if (getClass () == NativeAutoSuggestBox_SuggestCompleteAdapter_SuggestFilter.class)
			mono.android.TypeManager.Activate ("dotMorten.Xamarin.Forms.NativeAutoSuggestBox+SuggestCompleteAdapter+SuggestFilter, dotMorten.Xamarin.Forms.AutoSuggestBox", "", this, new java.lang.Object[] {  });
	}
